 ...
 */
public class GetCataData2Handler implements PacketHandler {
    private static final Logger logger = LoggerFactory.getLogger(GetCataData2Handler.class);
    private final Game game;
    
    public GetCataData2Handler(Game game) {
        this.game = game;
    }
