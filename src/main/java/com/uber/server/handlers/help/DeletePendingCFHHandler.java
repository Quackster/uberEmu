...
/**
 * Handler for deleting a pending CFH (Call for Help) ticket (message ID 238).
 * Ported from Messages/Requests/Help.cs DeletePendingCFH()
 */
public class DeletePendingCFHHandler implements PacketHandler {
    private static final Logger logger = LoggerFactory.getLogger(DeletePendingCFHHandler.class);
    private final Game game;
    
    public DeletePendingCFHHandler(Game game) {
        this.game = game;
    }
