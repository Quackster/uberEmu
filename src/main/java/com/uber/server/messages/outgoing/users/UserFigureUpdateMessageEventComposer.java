 ...
 */
public class UserFigureUpdateMessageEventComposer extends OutgoingMessageComposer {
    private final int virtualId; // -1 for self, otherwise virtual ID for room user
    private final String look;
    private final String gender;
    private final String motto;
    
    public UserFigureUpdateMessageEventComposer(int virtualId, String look, String gender, String motto) {
