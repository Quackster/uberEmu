 ...
 */
public class AchievementUnlockedMessageEventComposer extends OutgoingMessageComposer {
     ...
     */
    public AchievementUnlockedMessageEventComposer(ServerMessage message) {
