 ...
 */
public class TradingOpenEvent extends OutgoingMessageComposer {
    ...
    public TradingOpenEvent(long userOneId, boolean userOneAccepted, long userTwoId, boolean userTwoAccepted) {
