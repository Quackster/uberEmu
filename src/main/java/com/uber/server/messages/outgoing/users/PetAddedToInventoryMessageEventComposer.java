 ...
 */
public class PetAddedToInventoryMessageEventComposer extends OutgoingMessageComposer {
    private final ServerMessage petMessage;
    
    public PetAddedToInventoryMessageEventComposer(ServerMessage petMessage) {
