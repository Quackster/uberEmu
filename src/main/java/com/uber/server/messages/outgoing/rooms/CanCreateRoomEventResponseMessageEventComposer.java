 ...
 */
public class CanCreateRoomEventResponseMessageEventComposer extends OutgoingMessageComposer {
    private final boolean allow;
    private final int errorCode;
    
    public CanCreateRoomEventResponseMessageEventComposer(boolean allow, int errorCode) {
        this.allow = allow;
