 ...
 */
public class FurniRemovedFromInventoryMessageEventComposer extends OutgoingMessageComposer {
    private final long itemId;
    
    public FurniRemovedFromInventoryMessageEventComposer(long itemId) {
        this.itemId = itemId;
    }
