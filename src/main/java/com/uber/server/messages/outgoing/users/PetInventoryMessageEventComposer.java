 ...
 */
public class PetInventoryMessageEventComposer extends OutgoingMessageComposer {
    private final ServerMessage petInventoryMessage;
    
    public PetInventoryMessageEventComposer(ServerMessage petInventoryMessage) {
