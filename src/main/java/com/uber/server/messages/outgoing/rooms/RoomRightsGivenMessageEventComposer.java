 ...
 */
public class RoomRightsGivenMessageEventComposer extends OutgoingMessageComposer {
    private final long roomId;
    private final long userId;
    private final String username;
    
    public RoomRightsGivenMessageEventComposer(long roomId, long userId, String username) {
        this.roomId = roomId;
        this.userId = userId;
