 ...
 */
public class FurniInventoryMessageEventComposer extends OutgoingMessageComposer {
    private final ServerMessage furniInventoryMessage;
    
    public FurniInventoryMessageEventComposer(ServerMessage furniInventoryMessage) {
