 ...
 */
public class SubscriptionDataMessageEventComposer extends OutgoingMessageComposer {
    private final ServerMessage subscriptionMessage;
    
    public SubscriptionDataMessageEventComposer(ServerMessage subscriptionMessage) {
