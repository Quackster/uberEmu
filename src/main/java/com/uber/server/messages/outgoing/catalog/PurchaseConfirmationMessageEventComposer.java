 ...
 */
public class PurchaseConfirmationMessageEventComposer extends OutgoingMessageComposer {
    private final ServerMessage confirmationMessage;
    
    public PurchaseConfirmationMessageEventComposer(ServerMessage confirmationMessage) {
