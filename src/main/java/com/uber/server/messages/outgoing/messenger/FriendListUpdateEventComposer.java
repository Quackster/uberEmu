 ...
 */
public class FriendListUpdateEventComposer extends OutgoingMessageComposer {
     ...
     */
    public FriendListUpdateEventComposer(ServerMessage message) {
     ...
     */
    public FriendListUpdateEventComposer(int updateType, int updateCount, long friendId) {
