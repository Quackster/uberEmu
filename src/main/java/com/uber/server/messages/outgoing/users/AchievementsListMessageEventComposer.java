 ...
 */
public class AchievementsListMessageEventComposer extends OutgoingMessageComposer {
    private final ServerMessage achievementsMessage;
    
    public AchievementsListMessageEventComposer(ServerMessage achievementsMessage) {
