 ...
 */
public class RoomRightsRemovedMessageEventComposer extends OutgoingMessageComposer {
    private final long roomId;
    private final long userId;
    
    public RoomRightsRemovedMessageEventComposer(long roomId, long userId) {
        this.roomId = roomId;
        this.userId = userId;
    }
