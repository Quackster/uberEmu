...
public class RoomManager {
    ...
    public void loadRoom(long roomId) {
        ...
        // TODO: Initialize bots and pets when bot system is ported
        // room.initBots();
        // room.initPets();
        
        // TODO: Start process routine when room processing is ported
    ...
    public void requestRoomUnload(long roomId) {
        ...
        // TODO: Set keepAlive = false and stop process routine when implemented
        // room.setKeepAlive(false);
        // room.stopProcessRoutine();
        
        // For now, just unload immediately
        unloadRoom(roomId);
    }
